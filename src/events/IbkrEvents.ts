...
export enum IBKREVENTS {
    ...
    IBKR_COMPLETED_TRADES_UPDATED = 'IBKR_COMPLETED_TRADES_UPDATED',
    IBKR_OPEN_ORDERS_UPDATED = 'IBKR_OPEN_ORDERS_UPDATED',
    IBKR_POSITIONS_UPDATED = 'IBKR_POSITIONS_UPDATED',
    IBKR_ACCOUNT_UPDATED = 'IBKR_ACCOUNT_UPDATED',
}
