...
export class HistoricalData {
  ...
  public reqHistoricalData = (args: GetMarketData): Promise<HistoryData[]> => {
    ...
    return new Promise((resolve, reject) => {
      ...
      // handleError
      const eventfulError = handleEventfulError([`No historical market data for ${symbol}`, `The contract description specified for ${symbol} is ambiguous.`], endhistoricalData);
